...
/**
 * Test case for class \ms\MsSlider\Domain\Model\Slider.
 *
 * @version $Id$
 ...
 * @subpackage Slider
 *
 * @author ms <dev@mediasapiens.co>
 */
class SliderTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var \ms\MsSlider\Domain\Model\Slider
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new \ms\MsSlider\Domain\Model\Slider();
	}
	...
	public function setLinktextForStringSetsLinktext() { 
		$this->fixture->setLinktext('Conceived at T3CON10');

		$this->assertSame(
			'Conceived at T3CON10',
			$this->fixture->getLinktext()
		);
	}
